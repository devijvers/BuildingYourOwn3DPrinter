...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:param name="siteHref" select="'http://reprap.org'"/>
    <xsl:param name="docHref" select="'http://reprap.org'"/>
    <xsl:param name="siteLinkText" select="' '"/>
	<xsl:param name="docLinkText" select="' '"/>
